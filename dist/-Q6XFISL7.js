...
async function ensureTablesInitialized(env) {
...
async function registerRoutes(app) {
  ...
  async function ensureTablesExist2(env) {
    if (!env.DB)
      return;
    const create = [
  ...
  app.get("/api/user/:uuid/stats", async (c) => {
